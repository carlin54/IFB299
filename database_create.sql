...
ALTER TABLE `Orders` ADD CONSTRAINT `Orders_fk_RECIPENT_ID` 			
	...
	REFERENCES `Recipent`(`RECIPENT_ID`);
...
ALTER TABLE `Orders` ADD CONSTRAINT `Orders_fk_STATUS_DESCRIPTION` 
	FOREIGN KEY (`STATUS_DESCRIPTION`)
	REFERENCES `Status`(`STATUS_DESCRIPTION`);
